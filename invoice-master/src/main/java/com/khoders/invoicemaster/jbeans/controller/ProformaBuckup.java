...
//@SessionScoped
public class ProformaBuckup implements Serializable
{
...
//        List<ProformaInvoiceDto.TaxScheme> taxSchemeList = new LinkedList<>();
...
//        List<TaxScheme> taxSchemeListList  = proformaInvoiceService.getTaxSchemeList();
...
//        for (TaxScheme taxScheme : taxSchemeListList)
//        {
////            System.out.println("Tax Name: "+taxScheme.getTax().getTaxName() +"\t\t Tax Rate: "+taxScheme.getTax().getTaxRate());
//            
//            
//            ProformaInvoiceDto.TaxScheme scheme = new ProformaInvoiceDto.TaxScheme();
//            double salesTotal = 0.0, getFund=0.0, nhil=0.0, covid19=0.0, invoiceAmount = 0.0;
//            
//            LinkedHashMap<String, Double> taxMap = new LinkedHashMap<>();
//            
//            taxMap.put(taxScheme.getTax().getTaxName(), taxScheme.getTax().getTaxRate());
//            Set taxMapEntry = taxMap.entrySet();
//            Iterator iterator = taxMapEntry.iterator();
//            
//            for (ProformaInvoiceItem items : invoiceItemList) 
//            {   
//                salesTotal += (items.getQuantity() * items.getUnitPrice());
//            }
//            
//                getFund = salesTotal * taxScheme.getTax().getTaxRate();
//                nhil = salesTotal * taxScheme.getTax().getTaxRate();
//            System.out.println("\n\n");    
...
//                
//                
//                scheme.setTaxName(taxScheme.getTax().getTaxName());
//                scheme.setTaxAmount(invoiceAmount);
//                scheme.setTaxRate(taxScheme.getTax().getTaxRate());
//            
...
//            proformaInvoiceDto.setTaxList(taxSchemeList);
